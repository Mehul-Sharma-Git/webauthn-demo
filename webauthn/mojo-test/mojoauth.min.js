...
function signInWithWidget(api_key, redirecturl, lang) {
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        var apikey, webauthn_forced, language, redirect_url, widget, promise;
        return __generator(this, function (_f) {
            apikey = this.apikey ? this.apikey : api_key;
            webauthn_forced = (_a = this.config) === null || _a === void 0 ? void 0 : _a.enable_webauthn;
            language = ((_b = this.config) === null || _b === void 0 ? void 0 : _b.language) ? (_c = this.config) === null || _c === void 0 ? void 0 : _c.language : lang;
                ...
                document.addEventListener("DOMContentLoaded", function (event) {
                    ...
                    root.getElementById('mojoauth-passwordless-widget-form').onsubmit = function (e) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            SendMagiclink(apikey, email, lang, redirect_url).then(function (response) { resolve(response); }).catch(function (error) { console.log(error); });
                            return [2 /*return*/];
                        });
                    }); };
                    /*
